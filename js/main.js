...
(function() {
  var active, countries, filterList, filters, height, hover, inactive, map, polygon, separator, svg, svgHeight, svgWidth, tipSelectOne, tipSelectOther, tipSelectTwo, updateWindow, width;
  ...
  d3.select('#blur button').on('click', function() {
    return d3.select('#blur').classed('closed', true);
  });
  ...
  filterList.selectAll('div').on('click', filters.onClick);
